...
%endif
%configure --with-classads-prefix=/usr --with-globus-prefix=/usr
unset CPPFLAGS
unset LDFLAGS
make %{?_smp_mflags}
...
%changelog
* Thu Jan 26 2017 Brian Lin <blin@cs.wisc.edu> - 1.18.28.bosco-3.1e1e1af
- Put all \#SBATCH commands together (https://github.com/osg-bosco/BLAH/pull/51)
